...
public class GvrReticle : MonoBehaviour, IGvrGazePointer {
  ...
  protected float reticleDistanceInMeters = 10.0f;
  ...
  protected float reticleInnerDiameter = 0.0f;
  protected float reticleOuterDiameter = 0.0f;
  ...
  /// in tersected with a ray projected from the camera.
  ...
  public virtual void OnGazeExit(Camera camera, GameObject targetObject) {
